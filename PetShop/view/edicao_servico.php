  ...
  include_once('../controller/conexao.php');
    ...
    if ( isset($_POST['submit']) ) {
          ...
          $sql = "INSERT INTO cadastro_servico 
          ...
          if ($resultado) {
              ...
              mensagem("não foi possível cadastrar o serviço ", 'danger');
          }
...
<form action="#" method="POST">
  ...
  <h1 style="text-align: center; margin-top: 10px"><strong>Cadastro de Serviços</strong></h1>
...
<div class="container">
  ...
  <div class="row"><!--Linha 2-->
    ...
    <input name="disponibilidade" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
    </div>
    </div>
    <div class="col">
      <div class="input-group mb-3">
