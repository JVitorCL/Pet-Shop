<?php
	...
	if ( isset($_POST['submit']) ) {
        ...
        $sql = "INSERT INTO cadastro_animal 
                    (nome, peso, raca, idade, tipo, tamanho)
                VALUES 
                    ('$nome', '$peso', '$raca', '$idade', '$tipo', '$tamanho')";
...
<form action="#" method="POST">
	...
	<h1 style="text-align: center; margin-top: 10px" class="titulo"><strong>Cadastro de Animal</strong></h1>
<div class="container">
